!(function (a) {
  (a.emojioneList = {
    ...
    (a.asciiRegexp =
      "(\\<3|&lt;3|\\<\\/3|&lt;\\/3|\\:'\\)|\\:'\\-\\)|\\:D|\\:\\-D|\\=D|\\:\\)|\\:\\-\\)|\\=\\]|\\=\\)|\\:\\]|'\\:\\)|'\\:\\-\\)|'\\=\\)|'\\:D|'\\:\\-D|'\\=D|\\>\\:\\)|&gt;\\:\\)|\\>;\\)|&gt;;\\)|\\>\\:\\-\\)|&gt;\\:\\-\\)|\\>\\=\\)|&gt;\\=\\)|;\\)|;\\-\\)|\\*\\-\\)|\\*\\)|;\\-\\]|;\\]|;D|;\\^\\)|'\\:\\(|'\\:\\-\\(|'\\=\\(|\\:\\*|\\:\\-\\*|\\=\\*|\\:\\^\\*|\\>\\:P|&gt;\\:P|X\\-P|x\\-p|\\>\\:\\[|&gt;\\:\\[|\\:\\-\\(|\\:\\(|\\:\\-\\[|\\:\\[|\\=\\(|\\>\\:\\(|&gt;\\:\\(|\\>\\:\\-\\(|&gt;\\:\\-\\(|\\:@|\\:'\\(|\\:'\\-\\(|;\\(|;\\-\\(|\\>\\.\\<|&gt;\\.&lt;|\\:\\$|\\=\\$|#\\-\\)|#\\)|%\\-\\)|%\\)|X\\)|X\\-\\)|\\*\\\\0\\/\\*|\\\\0\\/|\\*\\\\O\\/\\*|\\\\O\\/|O\\:\\-\\)|0\\:\\-3|0\\:3|0\\:\\-\\)|0\\:\\)|0;\\^\\)|O\\:\\-\\)|O\\:\\)|O;\\-\\)|O\\=\\)|0;\\-\\)|O\\:\\-3|O\\:3|B\\-\\)|B\\)|8\\)|8\\-\\)|B\\-D|8\\-D|\\-_\\-|\\-__\\-|\\-___\\-|\\>\\:\\\\|&gt;\\:\\\\|\\>\\:\\/|&gt;\\:\\/|\\:\\-\\/|\\:\\-\\.|\\:\\/|\\:\\\\|\\=\\/|\\=\\\\|\\:L|\\=L|\\:P|\\:\\-P|\\=P|\\:\\-p|\\:p|\\=p|\\:\\-\xde|\\:\\-&THORN;|\\:\xde|\\:&THORN;|\\:\xfe|\\:&thorn;|\\:\\-\xfe|\\:\\-&thorn;|\\:\\-b|\\:b|d\\:|\\:\\-O|\\:O|\\:\\-o|\\:o|O_O|\\>\\:O|&gt;\\:O|\\:\\-X|\\:X|\\:\\-#|\\:#|\\=X|\\=x|\\:x|\\:\\-x|\\=#)"),
    (a.unicodeRegexp =
    ...
    (a.shortnameRegexp = ":([-+\\w]+):"),
    (a.imagePathPNG = "//cdn.jsdelivr.net/emojione/assets/png/"),
    (a.imagePathSVG = "//cdn.jsdelivr.net/emojione/assets/svg/"),
    (a.imagePathSVGSprites = "./../assets/sprites/emojione.sprites.svg"),
    (a.imageType = "png"),
    (a.sprites = !1),
    (a.unicodeAlt = !0),
    (a.ascii = !1),
    (a.cacheBustParam = "?v=1.2.4"),
    ...
    (a.shortnameToAscii = function (b) {
      ...
      return (b = b.replace(
        ...
        function (b) {
          return void 0 != b && "" != b && b in a.emojioneList
            ? ((c =
                a.emojioneList[b][a.emojioneList[b].length - 1].toLowerCase()),
      ...
      return (
        ...
        a.ascii &&
          (b = b.replace(
            ...
            function (b, d, e, f) {
              return void 0 != f && "" != f && a.unescapeHTML(f) in a.asciiList
                ? ((f = a.unescapeHTML(f)),
      ...
      return (
        ...
        a.ascii &&
          (b = b.replace(
            ...
            function (b, f, g, h) {
              return void 0 != h && "" != h && a.unescapeHTML(h) in a.asciiList
                ? ((h = a.unescapeHTML(h)),
                  (d = a.asciiList[h].toUpperCase()),
                  (e = a.unicodeAlt ? a.convert(d) : a.escapeHTML(h)),
                  (c =
                    "png" == a.imageType
                      ? a.sprites
                        ? g +
    ...
    (a.unicodeToImage = function (b) {
      ...
      return (b = b.replace(
        ...
        function (b) {
          return void 0 != b && "" != b && b in a.jsecapeMap
            ? ((d = a.jsecapeMap[b]),
              (e = a.unicodeAlt ? a.convert(d) : f[d]),
              (c =
                "png" == a.imageType
                  ? a.sprites
                    ? '<span class="emojione-' +
    ...
    (a.mapShortToUnicode = function () {
      ...
      for (var c in a.emojioneList)
        for (var d in a.emojioneList[c])
          b[a.emojioneList[c][d].toUpperCase()] = c;
      return b;
    }),
