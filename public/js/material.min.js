!(function (a) {
  function b(a) {
    return "undefined" == typeof a.which
      ...
      ? !a.ctrlKey && !a.metaKey && !a.altKey && 8 != a.which
      : !1;
  }
      ...
      input: function (c) {
        a(c ? c : this.options.inputElements)
          ...
          .each(function () {
            var b = a(this);
            if (
              (b.wrap("<div class=form-control-wrapper></div>"),
              ...
              b.attr("placeholder", null).removeClass("floating-label"),
                b.after("<div class=floating-label>" + c + "</div>");
            }
            if (
              (b.attr("data-hint") &&
                b.after("<div class=hint>" + b.attr("data-hint") + "</div>"),
      ...
      init: function () {
        a.fn.ripples && this.options.ripples && this.ripples(),
          ...
          document.arrive &&
            ...
            this.options.input &&
              a(document).arrive(this.options.inputElements, function () {
                a.material.input(a(this));
              }),
            this.options.checkbox &&
              a(document).arrive(this.options.checkboxElements, function () {
                a.material.checkbox(a(this));
              }),
            this.options.radio &&
              a(document).arrive(this.options.radioElements, function () {
